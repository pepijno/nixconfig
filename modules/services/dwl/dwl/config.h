...
static const Rule rules[] = {
	...
	{ "Vivaldi-stable",  NULL,       1 << 1,       0,           -1 },
	{ "steam",           NULL,       1 << 4,       0,           -1 },
	{ "Tor Browser",     NULL,       1 << 3,       0,           -1 },
};
...
static const char *menucmd[] = { "${wmenu}/bin/wmenu-run", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_F,          spawn,          {.v = librewolfcmd } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_B,          spawn,          {.v = vivaldicmd } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_F,          spawn,          {.v = librewolfcmd } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_O,          spawn,          {.v = torcmd } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_S,          spawn,          {.v = steamcmd } },

	{ 0,                         XKB_KEY_XF86AudioLowerVolume, spawn, {.v = pactldecrease } },
	{ 0,                         XKB_KEY_XF86AudioRaiseVolume, spawn, {.v = pactlincrease } },
	{ 0,                         XKB_KEY_XF86AudioMute,        spawn, {.v = pactlmute } },
